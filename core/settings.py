...
SECRET_KEY = "django-insecure-nn9-kw)jb^%#e60=w9c#lt-f&fte_mhao2t1)*7g3ui#eofn2@"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '82.115.17.104']
...
# Celery Settings
CELERY_BROKER_URL = (
    "redis://redis:6379/0"  # Address to connect to the redis service in Docker
)
CELERY_RESULT_BACKEND = (
    "redis://redis:6379/0"  # The results of the tasks are also saved here.
)
